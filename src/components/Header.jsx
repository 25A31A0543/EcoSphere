...
import { getLastGCPSyncTime } from '../data/storage';
...
export default function Header({ 
  ...
  const handleVoiceNarrateHeader = () => {
    ...
    if (!isVoiceActive && 'speechSynthesis' in window) {
      const text = `EcoSphere platform for Pragati Engineering College and Greenery Club. Tagline: Together for a Greener Tomorrow.`;
      ...
      <div className="header-top-bar">
        <div className="ticker-content">
          ...
          <span className="ticker-text">
            Pragati Greenery Drive: 1,420 kg Plastic Saved • 100+ DIY IoT Bins Active
          </span>
        </div>
      ...
      <div className="header-main-container">
        ...
        <div className="brand-group" onClick={() => onTabChange('home')} style={{ cursor: 'pointer' }}>
          <div className="logo-sphere">
            <Globe className="globe-spin" size={32} />
            <Leaf className="leaf-overlay" size={18} />
          </div>
          <div className="brand-titles">
            <div className="brand-headers-stack">
              <span className="college-name">Pragati Engineering College</span>
              <span className="club-name">Greenery Club</span>
              <span className="ecovision-name">EcoVision 360</span>
            </div>
        ...
        <nav className={`header-nav ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
          ...
          <button 
            ...
            onClick={() => { onTabChange('community'); setIsMobileMenuOpen(false); }}
          >
            <User size={16} />
        ...
        <div className="header-actions">
          ...
          {/* User Account / Google OAuth Button */}
